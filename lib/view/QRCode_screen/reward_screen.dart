...
// import 'package:sky_diving/components/reward_list_shimmer.dart';
...
//     width: screenWidth * 0.9,
//     height: screenHeight * 0.6,
//     child: isRewardLoading
//         ? const RewardListShimmer()
//         : RewardsTabBar(rewardList: rewardList),
//   ),
// ),
//               ],
//             ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        // Show full screen loading only if referral data is loading or error
        ...
        // Show UI except rewards list immediately
        return Padding(
          padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.05),
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Only this part shows shimmer while loading
                Center(
                  child: SizedBox(
                    width: screenWidth * 0.9,
                    height: screenHeight * 0.6,
