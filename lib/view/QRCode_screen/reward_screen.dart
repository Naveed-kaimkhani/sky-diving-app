...
//   final referralController = Get.find<ReferralController>();
//   final userController = Get.find<UserController>();
//   final userRewardController = Get.put(UserRewardController(), permanent: true);

//   @override
//   void initState() {
//     super.initState();

//     // Fetch only if rewards list is empty
//     if (userRewardController.rewards.isEmpty) {
//       userRewardController.fetchUserRewards(userController.token.value);
//     }
//   }
