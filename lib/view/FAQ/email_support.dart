...
final   SupportController controller = Get.put(SupportController(supportRepo: SupportRepo()));
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: AuthButton(
                    buttonText: "Submit",
                    onPressed: () => controller.submitSupportForm(userController.user.value!.id??0),
